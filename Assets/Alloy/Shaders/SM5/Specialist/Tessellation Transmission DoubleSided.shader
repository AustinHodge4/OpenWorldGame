...
Shader "Alloy/Tessellation/Transmission/DoubleSided" {
Properties {
	// Settings
	...
	_TransmissionProperties ("'Transmission Properties' {Section:{126, 118, 41}}", Float) = 0
	_TransColor ("'Tint' {}", Color) = (1,1,1)
	_TransTex ("'Color' {Visualize:{RGB}, Parent:_MainTex}", 2D) = "white" {}
	[Gamma]
	...
	_TransShadowWeight ("'Shadow Weight' {Min:0, Max:1}", Float) = 1
	_TransInvertBackNormal ("'Invert Back Normal' {Toggle:{On:{}, Off:{}}}", Float) = 0
...
CGINCLUDE
	#define ALLOY_ENABLE_DOUBLESIDED
...
FallBack "Alloy/Transmission/DoubleSided"
