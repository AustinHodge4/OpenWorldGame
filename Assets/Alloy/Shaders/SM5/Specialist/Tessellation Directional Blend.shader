...
Properties {
	...
	// Directional Blend Properties
	_OrientedBlendProperties ("'Directional Blend Properties' {Section:{41, 74, 126}}", Float) = 0
	...
	_OrientedBlend ("'Blend' {Min:0, Max:1}", Float) = 0.1
...
FallBack "Alloy/Directional/Blend World"
