...
Shader "Alloy/Tessellation/Hair/HighQuality DoubleSided" {
Properties {
	// Settings
	...
	_PrimaryAnisoProperties ("'Primary Aniso Properties' {Section:{126, 92, 41}}", Float) = 0
	...
	_SecondaryAnisoProperties ("'Secondary Aniso Properties' {Section:{126, 118, 41}}", Float) = 0
...
FallBack "Alloy/Hair/HighQuality DoubleSided"
